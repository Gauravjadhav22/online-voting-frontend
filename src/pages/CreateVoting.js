        ...
        InputForm.push(
            <form key={i} className='absolute my-4 mt-12 ml-0' onSubmit={handleSubmit}>
                <div key={i} className="shadow shadow-cyan-400 bg-slate-500 rounded-2xl text-blueBg w-fit p-3 my-2">
                    ...
                    {!imgUploaded && <div className='my-4 w-fit flex justify-between items-center text-xl'>

                        <label className='font-semibold'>Profile pic:</label >
                        <input onChange={(e) => {
                            uploadImg(e.target.files[0])
                        }} className='rounded-lg p-1 ml-3 bg-blueBg text-white' required type="file" />
                    </div>}
                ...
                loading ? (
                    ...
                    <div className='flex justify-center'>
                        <div className='mx-8 my-4 capitalize fle flex-col items-center  text-white mt-14'>
                            ...
                            {/* <div>
                                {
                                    roomPass && <h1>password of this room --&gt; {roomPass} </h1>
                                }
                            </div> */}
