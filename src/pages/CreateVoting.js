...
const CreateVoting = () => {
  ...
  const uploadImg = (img) => {
    ...
    axios
      .post("https://api.cloudinary.com/v1_1/dfloi7bv1/image/upload", data)
      .then((res) => {
  ...
  for (var i = 0; i < noOfRivals; i++) {
    InputForm.push(
      <form
        key={i}
        className="absolute my-4 mt-12 ml-0"
        onSubmit={handleSubmit}
      >
        <div
          key={i}
          className="items-center justify-center shadow shadow-cyan-400 bg-slate-500 rounded-2xl text-blueBg w-fit p-3 my-2 "
        >
          <h1 className="text-3xl text-center font-semibold">
            Enter details for participant{" "}
            <span className="text-4xl text-white normal-case">{i + 1}</span>
          </h1>
            ...
            <>
              <div className="my-4 w-fit flex justify-between items-center text-xl">
                ...
                <input
                  ...
                  name="name"
                  className="rounded-lg p-1 ml-3 bg-blueBg text-white"
                  type="text"
                  placeholder="cj"
                />
              </div>
          ...
          {!imgUploaded && (
            <div className="text-xl flex justify-center w-96">
              <label className="font-semibold flex flex-col items-center mt-4 py-2 px-14">
                ...
                <input
                  ...
                  className="rounded-lg  bg-blueBg invisible"
                  required
                  type="file"
                />
              </label>
        ...
        <button
          ...
          type="submit"
          className="w-full bg-green-500 p-1 text-3xl rounded-xl"
        >
          submit
        </button>
      </form>
        ...
        <div className="flex justify-center">
          <div className="mx-8 my-4 capitalize fle flex-col items-center  text-white mt-14">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="border-2 rounded mt-8 mx-2 p-2 bg-black border-blue-700"
                    required
                ...
                <div className="my-5">
                  ...
                  <input
                    ...
                    required
                    placeholder="1"
                    className="text-blueBg px-1 w-16 text-center"
                    min="1"
                    max="24"
                    type="number"
                  />
                ...
                <input
                  className="p-1 bg-purple-700 rounded-lg"
                  type="submit"
                  value="submit"
                />
              </form>
            ...
            {selected && !inputVisible && (
              <div className="mt-14 text-2xl flex">
                <label className="font-semibold " htmlFor="noofrivals">
                  no of Participants:
                </label>
                <select
                  name="noofrivals"
